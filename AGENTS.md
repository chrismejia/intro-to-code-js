...
For supporting detail, see [Maintainer Guide](docs/maintainer/maintainer-guide.md) and
[Repository Layout](docs/maintainer/repository-layout.md). Claude-specific agent guidance lives in [CLAUDE.md](CLAUDE.md).
...
[Branching And PR Workflow](docs/maintainer/pr-workflow.md) and
...
- Teaching/support material belongs here, including `teaching-notes/`,
  `wip-problems/`, internal docs, `AGENTS.md`, and `CLAUDE.md`.
...
- Current files must not include instructor-only folders such as `docs/`, `teaching-notes/`, or `wip-problems/`.
...
- `docs/`, `teaching-notes/`, `wip-problems/`, `AGENTS.md`,
...
When restoring or changing `0X-Guide`, prefer known-good answer-bearing lesson
files and run the relevant unit tests. Do not make guide tests pending to hide
missing or broken answers.
...
[Repository Layout](docs/maintainer/repository-layout.md), and
[Testing Branch Behavior](docs/maintainer/testing-branch-behavior.md).
...
[Testing Branch Behavior](docs/maintainer/testing-branch-behavior.md) and
...
- PRs into `main` should guard student-clean state. The current
  ...
  paths (`AGENTS.md`, `CLAUDE.md`, `docs/`, `teaching-notes/`, and
...
[Branching And PR Workflow](docs/maintainer/pr-workflow.md). For beginner-friendly Git
command examples, see [Git Basics](docs/maintainer/git-basics.md).
