...
describe("#1: objectFlattener", function () {
  ...
  describe("when the input has no object values", function () {
    it("the untouched input is returned", function () {
      expect(objectFlattener(noSubObject)).to.eql(noSubObject);
    });
  });

  describe("when the input has object values", function () {
    describe("the returned object has each sub object's key-value pairs", function () {
      describe("when there is one sub object", function () {
        it("one key-value pair e.g. { three: { four: 1 }}", function () {
        ...
        it("multiple key-value pairs e.g. { three: { four: 3, five: 'hello' }}", function () {
      ...
      describe("when there are multiple sub objects", function () {
        it("each having one key-value pair e.g. { one: { two: 1 }, three: { four: 4 } }", function () {
        ...
        it("for multiple sub objects key-value pairs", function () {
      ...
      describe("when all input object values", function () {
        it("are objects with a mixed number of key-value pairs", function () {
