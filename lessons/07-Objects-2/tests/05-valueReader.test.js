...
describe("#5: valueReader", function () {
  describe("returns the correct value", function () {
    it("when the key-value pair exists in the data object", function () {
    ...
    it("when the key does not exist in the data object", function () {
