...
export const allCoursesAns = {
  courses: [
    {
      courseName: "Introduction to Psychology",
      students: ["Alice Johnson", "Olivia Rivera"],
    },
    {
      courseName: "English Composition",
      students: [
    ...
    {
      courseName: "Public Speaking",
      students: ["Emma Brown", "Quinn Baker", "Carmen Ramirez"],
    },
    {
      courseName: "Chemistry 101",
      students: [
    ...
    {
      courseName: "Statistics",
      students: ["David Lee", "Grace Kim", "Noah Scott", "Ben Taylor"],
    },
    {
      courseName: "Calculus I",
      students: [
    ...
    {
      courseName: "Political Science 101",
      students: ["Liam Hall", "Wendy Hill"],
    },
    {
      courseName: "Introduction to Business",
      students: ["Emma Brown", "Henry Clark", "Quinn Baker", "Carmen Ramirez"],
    },
    {
      courseName: "Ethics",
      students: [
    ...
    {
      courseName: "Spanish I",
      students: ["Mia Nelson", "Uma Foster"],
    },
  ],
  courseCount: 20,
  studentCount: 30,
...
export const electiveCoursesAns = {
  courses: [
    {
      courseName: "Introduction to Sociology",
      students: [
...
export const mandatoryCoursesAns = {
  courses: [
    {
      courseName: "Introduction to Psychology",
      students: ["Alice Johnson", "Olivia Rivera"],
