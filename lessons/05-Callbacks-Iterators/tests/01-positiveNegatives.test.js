...
describe("#1: Positives & Negatives", function () {
  ...
  describe("numType", function () {
    ...
    it("runs the callback function using both of numTypes number inputs", function () {
    ...
    describe("when a times b is positive", function () {
      it("runs the multiplyNums callback only once", function () {
        expect(abSpy.calledOnce).to.be.true;
        expect(cdSpy.calledOnce).to.be.true;
      });

      it("returns the correct report string", function () {
    ...
    describe("when a times b is negative", function () {
      it("runs the multiplyNums callback twice", function () {
    ...
    describe("when a times b is zero", function () {
      it("runs the multiplyNums callback twice", function () {
