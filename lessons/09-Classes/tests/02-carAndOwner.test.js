...
describe("#2: Car and Owner", function () {
  let myCar, myOwner;
  ...
  describe("Owner", function () {
    ...
    it("is a subclass off of Car", function () {
    ...
    describe("inherited properties and methods", function () {
      it("inherits `year`, `make`, `model`, `miles` from the Car class", function () {
