...
describe("#1: Rectangle", function () {
  ...
  it("accepts two number inputs for its length and width", function () {
  ...
  it("has the instance method `area`", function () {
    expect(myRect.area).to.be.a("function");
    expect(mySquare.area).to.be.a("function");
  });

  it("has the instance method `perimeter`", function () {
    expect(myRect.perimeter).to.be.a("function");
    expect(mySquare.perimeter).to.be.a("function");
  });

  it("the instance method `area` correctly returns the area of the rectangle", function () {
    expect(myRect.area()).to.equal(30);
    expect(mySquare.area()).to.equal(100);
  });

  it("the instance method `perimeter` correctly returns the area of the rectangle", function () {
